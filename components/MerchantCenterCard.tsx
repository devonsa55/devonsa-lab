...
export function MerchantCenterCard({ data }: MerchantCenterCardProps) {
  ...
  return (
    <Card className="border-border/80 shadow-md bg-card transition-all duration-200 hover:shadow-lg flex flex-col justify-between overflow-hidden">
      <div>
        <CardHeader className="pb-3 border-b border-border/40 bg-muted/20">
          <div className="flex items-center justify-between">
            ...
            <Badge variant="outline" className="text-[11px] font-mono border-blue-500/30 text-blue-700 bg-blue-50/50 dark:bg-blue-950/40 dark:text-blue-300">
              Insight
            </Badge>
          </div>
        </CardHeader>
